    ...
    <div class="space-y-5 animate-slide-up">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            phx-click="retry_failed_videos"
            class="glass-btn glass-btn-secondary px-2 py-1.5 text-[10px] flex items-center gap-1"
            title={dgettext("projects", "Retry failed video tasks")}
          >
          ...
          <button
            phx-click="retry_failed_voices"
            class="glass-btn glass-btn-secondary px-2 py-1.5 text-[10px] flex items-center gap-1"
            title={dgettext("projects", "Retry failed voice tasks")}
          >
            <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
              <path d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182" />
            </svg>
            {dgettext("projects", "Retry Voice")}
          </button>
        </div>
      </div>

defmodule AstraAutoEx.AI.ArtStyles do
  ...
  @styles [
    %{
      ...
      prompt_en:
        "Photorealistic live-action footage with extreme facial detail, natural skin texture, 8K resolution, cinematic lighting"
    },
    %{
      ...
      prompt_en:
        "35mm film grain, anamorphic lenses, cinematic color grading, warm tones, shallow depth of field"
    },
    %{
      ...
      prompt_en:
        "Japanese cel-shading style, saturated bright colors, Ghibli-style atmospheric feel, refined linework"
    },
    %{
      value: "chinese-comic",
      label: "精致国漫",
    ...
    %{
      ...
      prompt_en:
        "Pixar/Disney style 3D rendering, soft lighting, cartoon texture, refined materials"
    },
    %{
      value: "film-noir",
      label: "黑色电影",
    ...
    %{
      ...
      prompt_en:
        "Neon lights, rainy urban nights, futuristic tech, purple-blue tones, holographic projections"
    },
    %{
      value: "ink-wash",
      label: "水墨画",
      ...
      prompt_en:
        "Traditional Chinese ink wash painting, white space aesthetics, subtle ink tones, landscape freehand"
    },
    %{
      value: "retro-vintage",
      label: "复古怀旧",
    ...
    %{
      value: "macro-cinema",
      label: "微距电影",
      label_en: "Macro Cinema",
      prompt_zh: "极致微距镜头，超浅景深，细节放大，电影级微观世界",
      prompt_en:
        "Extreme macro lens, ultra-shallow depth of field, magnified details, cinematic micro world"
    },
    %{
      value: "epic-scifi",
      label: "史诗科幻",
      ...
      prompt_en:
        "Grand space scenes, future cities, interstellar warships, cosmic visual spectacle"
    },
    %{
      value: "clay-stopmotion",
      label: "粘土定格",
    ...
    %{
      ...
      prompt_en:
        "Eastern xianxia style, ethereal atmosphere, classical architecture, misty clouds, live-action quality"
    }
  ]

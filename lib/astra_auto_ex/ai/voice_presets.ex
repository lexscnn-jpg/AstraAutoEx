defmodule AstraAutoEx.AI.VoicePresets do
  ...
  def load_from_api(user_id) do
    ...
    with {:ok, config} <- Helpers.get_provider_config(user_id, "minimax") do
      case AstraAutoEx.AI.Providers.Minimax.list_voices(config) do
        ...
        {:error, reason} ->
          Logger.warning("[VoicePresets] Failed to load from API: #{inspect(reason)}, using defaults")
          {:error, reason}
      end
    end
  end
  ...
  defp default_presets do
    [
      %{id: "Calm_Woman", name: "沉稳女声", gender: "female", language: "zh", category: "通用", description: "温柔沉稳的成熟女声"},
      %{id: "Gentle_Woman", name: "温柔女声", gender: "female", language: "zh", category: "通用", description: "轻柔甜美的女声"},
      %{id: "Sweet_Girl", name: "甜美少女", gender: "female", language: "zh", category: "通用", description: "活泼可爱的少女声"},
      %{id: "Confident_Woman", name: "自信女声", gender: "female", language: "zh", category: "通用", description: "干练自信的职业女声"},
      %{id: "Deep_Voice_Man", name: "低沉男声", gender: "male", language: "zh", category: "通用", description: "浑厚低沉的男声"},
      %{id: "Warm_Man", name: "温暖男声", gender: "male", language: "zh", category: "通用", description: "温暖亲切的男声"},
      %{id: "Young_Man", name: "青年男声", gender: "male", language: "zh", category: "通用", description: "阳光开朗的年轻男声"},
      %{id: "Narrator", name: "旁白", gender: "male", language: "zh", category: "旁白", description: "专业沉稳的旁白配音"},
      %{id: "Cute_Boy", name: "可爱男孩", gender: "male", language: "zh", category: "儿童", description: "稚嫩可爱的男童声"},
      %{id: "Energetic_Girl_EN", name: "活力女生(英)", gender: "female", language: "en", category: "英文", description: "Energetic young female voice"},
      %{id: "Professional_Man_EN", name: "专业男声(英)", gender: "male", language: "en", category: "英文", description: "Professional male narrator"},
      %{id: "Friendly_Woman_EN", name: "友好女声(英)", gender: "female", language: "en", category: "英文", description: "Friendly warm female voice"}
    ]
  end
end
